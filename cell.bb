...
;TEXTURE VARIABLES
Global WallTex = LoadTexture("Textures/wallpaper.jpg",256)
Global FloorTex = LoadTexture("Textures/carpet.jpg",256)
Global CeilingTex = LoadTexture("Textures/ceiling.jpg",256)
Global CornerTex = LoadTexture("Textures/column.jpg",256)
...
Function DeleteCell.Cell(c.Cell)
